...
tags: ["case", "fourth-amendment", "license-plate-reader", "digital-surveillance", "plain-view", "reasonable-suspicion", "fifth-circuit"]
related: ["[[Carpenter v. United States]]", "[[United States v. Knotts]]", "[[Terry Stops and Reasonable Suspicion]]"]
aliases: ["United States v. Porter", "United States v. Porter (5th Cir. 2026)", "United States v. Elijah Porter"]
---
...
## Application
Detecting a plate as the vehicle passed a fixed public-road camera revealed only a vehicle's public movement and did not invade a reasonable expectation of privacy, so it was no search and needed no warrant. The LPR alert plus the confirmed link to a person with an active warrant supplied reasonable suspicion (indeed probable cause) for the stop. Once Porter was stopped, the barrel and switch were visible under the seat, bringing the firearm within the plain-view doctrine; its incriminating character (an apparent automatic Glock) was immediately apparent.
