...
| `lint14_pagerecord.py` | **LINT-14** | **S2 R12/A16** | Every non-draft `type: case` page resolves to a lake record whose status is `verified`, `under_review`, `slip_opinion`, `verified_off_cl`, or `verified_identity`; records need not have pages. |
