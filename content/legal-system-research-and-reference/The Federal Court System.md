...
aliases:
  ...
  - "2-legal-system-research/The-Federal-Court-System"
...
status: verified
related: ["[[Reading and Citing Cases]]", "[[Verifying Good Law]]", "[[State Citations and Conventions]]", "[[Common Legal Terms]]", "[[Fourth Amendment Framework]]"]
---

# The Federal Court System

Every doctrine page in this wiki weights authority the same way: **SCOTUS binding; a circuit holding binds only within its own circuit (Persuasive (outside circuit) elsewhere, with splits flagged); state cases illustrative only (Persuasive — state, illustrative).** That hierarchy is not a house preference. It is how the federal judiciary actually works, and it is the spine of the wiki's six-tier authority lexicon (see [[Verifying Good Law]]). This page explains *why* a Ninth Circuit case binds in San Francisco but not in Dallas, why a district-court opinion settles nothing, and why a "circuit split" is a signal rather than a rule. Read it once, then lean on it whenever you decide how much a case is worth.
...
- **When circuits disagree, that is a *circuit split*.** The same federal question, answered differently in different circuits, means the governing rule literally depends on where you stand until SCOTUS resolves it. A split is a **classic cert vehicle**, not settled law.
...
**Composition.** The Court today has **9 Justices**: one **Chief Justice** and **eight Associate Justices**. The **Constitution mentions only the Chief Justice** (Art. I references the Chief Justice presiding over an impeachment trial of the President); it does **not** fix the Court's size. **Congress sets the number of Associate Justices** by statute: the number has ranged from **6 to 10** over the nation's history and has been **fixed at 9 since 1869**. *(John Roberts is, by the usual count, the 17th Chief Justice, a historical tally rather than a count of sitting seats.)*

**Appointment and tenure.** Justices are **nominated by the President** and **confirmed by the Senate**. Under **Article III**, they hold office "during good Behaviour," which in practice means **lifetime tenure** absent resignation, retirement, or impeachment.
...
- [*Marbury v. Madison*, 5 U.S. (1 Cranch) 137 (1803)](https://www.courtlistener.com/opinion/84759/marbury-v-madison/) (establishes judicial review; the "province and duty of the judicial department" passage is at 177).

Civic and structural references (official, for the court-system facts, not case authority):

- [Court Role and Structure (uscourts.gov)](https://www.uscourts.gov/about-federal-courts/court-role-and-structure)
- [About the Court (supremecourt.gov)](https://www.supremecourt.gov/about/about.aspx)
- [The Justices' Caseload (supremecourt.gov)](https://www.supremecourt.gov/about/justicecaseload.aspx)
