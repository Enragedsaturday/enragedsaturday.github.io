...
weight: 30
aliases:
  - "State Citations and Conventions"
  - "State Citations & Conventions"
  - "2-legal-system-research/State-Citations-and-Conventions"
  - "state-citations-conventions"
title: "State Citations & Conventions"
topic: State Citations and Conventions
type: reference
jurisdiction: State (citation & reporting conventions)
status: draft
related: ["[[Reading and Citing Cases]]", "[[Legal Research Tools]]", "[[Verifying Good Law]]", "[[The Federal Court System]]", "[[Common Legal Terms]]"]
---
...
- **State v. ___**: most states (Ohio, Florida, New Jersey, Washington).
...
You do not need Westlaw to pull a state supreme-court opinion. The fastest free routes are the same primary-source tools the wiki verifies against (full toolset on [[Legal Research Tools]]):
...
Confirm the text on the court's own site or CourtListener before you rely on it, then check that it is still good law on [[Verifying Good Law]].

## Sources

State citation and reporting conventions (practice references, not case authority):
...
- [OpenCase](https://www.opencase.com/) (AI-assist; full caveat on [[Legal Research Tools]]).
