...
- **RE — Recognized Exception.** One of the established exceptions to the warrant requirement (exigent circumstances, search incident to arrest, the automobile exception, plain view, inventory, *Terry* frisks, and the like). This is the **broad bucket**, and its full catalog is developed later in the course.
...
**Three justifications, not four.** The letters **C · R · E · W** spell the acronym, but **RE** is a single item (Recognized Exception); exigency is one example *inside* RE, never a separate fourth justification.
