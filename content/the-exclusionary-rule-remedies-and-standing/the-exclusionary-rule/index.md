...
- [[Fruits & Attenuation]] — how far the taint reaches (the fruit of the poisonous tree) and when the causal chain is so weakened that the taint is purged. Owns the rule's origin and reach, and the impeachment exception.
...
- [[Inevitable Discovery & Independent Source]] — a lawful source that *actually* produced the evidence (independent source) or a lawful route that *would* have produced it anyway (inevitable discovery).
