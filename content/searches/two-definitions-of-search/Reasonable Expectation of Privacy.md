...
**It runs in parallel with trespass, not in sequence.** *[[Katz v. United States|Katz]]* did not replace the property baseline; the two theories are independent. As *[[United States v. Jones|Jones]]* put it, the privacy test "has been *added to*, not *substituted for*, the common-law trespassory test." *[[United States v. Jones#^pin-409|Jones]]*, 565 U.S. 400, 409 (2012). A privacy invasion is a search even with no physical entry, which is exactly what *[[Katz v. United States|Katz]]* held for the electronic bug on the outside of a public phone booth.
