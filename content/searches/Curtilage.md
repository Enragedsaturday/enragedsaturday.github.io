...
**The implied license defines the *scope*, not just the place.** The reason an officer (or a Girl Scout) may walk up and knock is a narrow implied social license — the rule is stated once, on [[Knock and Talk]], and embedded here:

> [!rule] Black-letter rule — stated on [[Knock and Talk]]
> ![[Knock and Talk#^rule-knock-and-talk]]
