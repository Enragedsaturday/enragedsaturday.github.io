...
**Scope and duration: brief, diligent, least intrusive.**
- A *[[Terry v. Ohio|Terry]]* stop must stay **temporary** and use "the least intrusive means reasonably available to verify or dispel the officer's suspicion in a short period of time." *[[Florida v. Royer#^pin-500|Florida v. Royer]]*, 460 U.S. 491, [500](https://www.courtlistener.com/opinion/110890/florida-v-royer/) (1983) (plurality).
- There is **no rigid time limit**. The test is **diligence**: "whether the police diligently pursued a means of investigation that was likely to confirm or dispel their suspicions quickly." *[[United States v. Sharpe#^pin-685|United States v. Sharpe]]*, 470 U.S. 675, [685–86](https://www.courtlistener.com/opinion/111378/united-states-v-sharpe/) (1985).
- A stop that drags on without diligent investigation, or that seizes property far past what investigation needs, breaks the limit: a 90-minute detention of luggage "exceeded the permissible limits of a *Terry*-type investigative stop." *[[United States v. Place#^pin-709|United States v. Place]]*, 462 U.S. 696, [709](https://www.courtlistener.com/opinion/110979/united-states-v-place/) (1983).
- And once the suspicion that justified the stop is **dispelled**, the detention must end; the officer may not hold the person to keep looking for something else.

**When a stop hardens into an arrest: the [[Common Legal Terms#de-facto|de facto]]-arrest and transport line.** Over-intrusiveness, not just clock time, can convert a stop into an arrest that needs probable cause.
- Holding a suspect's ticket and identification in a small interrogation room did just that: "[a]s a practical matter, Royer was under arrest." *[[Florida v. Royer#^pin-503|Royer]]*, 460 U.S. at [503](https://www.courtlistener.com/opinion/110890/florida-v-royer/).
- The clearest line is **removal and transport**: taking a suspect from the scene to the stationhouse for investigation is an arrest requiring probable cause, whether the purpose is interrogation or fingerprinting.
- The two-road analysis and the transport cases (*[[Davis v. Mississippi|Davis]]*, *[[Hayes v. Florida|Hayes]]*, *[[Dunaway v. New York|Dunaway]]*) are developed on **[[Seizure of the Person]]**.
- The point for the field is that a *[[Terry v. Ohio|Terry]]* detention that grows into a custodial removal has left *[[Terry v. Ohio|Terry]]* behind.
...
**Acting on another officer's suspicion, and compelling a name.** The suspicion that justifies a stop need not sit in the stopping officer's own head.
- An officer may stop in objective reliance on a **wanted flyer, BOLO, or dispatch** if the issuing agency had reasonable suspicion; that is the fellow-officer rule, developed on **[[Collective Knowledge and the Fellow-Officer Rule]]** (*[[United States v. Hensley|Hensley]]*).
- Separately, during a **valid** stop a State may, by statute, compel the suspect to give his **name**; whether it may, and the vagueness limit on such statutes, is the stop-and-identify question owned by **[[Stop-and-Identify]]** (*[[Hiibel v. Sixth Judicial Dist. Court|Hiibel]]*; *[[Kolender v. Lawson|Kolender]]*).
- Note only that there is no power to demand identity without reasonable suspicion in the first place. *[[Brown v. Texas#^pin-51|Brown v. Texas]]*, 443 U.S. 47, [51](https://www.courtlistener.com/opinion/110128/brown-v-texas/) (1979).
...
- **United States v. Wilson (5th Cir. 2025)** — *post-Bruen: lawful gun possession alone is not suspicion.* After the Supreme Court's *Bruen* decision recognizing a general right to carry, the visible or suspected possession of a firearm cannot **by itself** ground reasonable suspicion, because public carry is now **presumptively lawful nationwide** rather than a state-by-state privilege; officers need particularized facts beyond the gun. No. 23-30777 (5th Cir. 2025). **Binding in-circuit — 5th Cir.** [opinion](https://www.courtlistener.com/opinion/10636220/united-states-v-wilson/)

The SCOTUS two-showing framework is stable, but the circuits divide over the **frisk branch** where a State permits gun carry: the Fourth Circuit [[Reading and Citing Cases#en-banc|en banc]] treats reasonable suspicion that a stopped person is *armed* as by itself enough to frisk (*[[United States v. Robinson|Robinson]]*), while the open-carry cases hold that lawfully carrying a firearm, without more, supplies neither suspicion of a crime nor a basis to disarm (*[[United States v. Black|Black]]*; *[[Northrup v. City of Toledo Police Dept|Northrup]]*). The dividing question is whether "armed and dangerous" collapses into "armed" once a State makes public carry lawful. After *Bruen*, the Fifth Circuit (*Wilson*) sharpens the open-carry side **on the stop branch**: because public carry is now presumptively lawful **nationwide**, the visible or suspected possession of a firearm cannot **by itself** ground reasonable suspicion for the stop; officers need particularized facts beyond the gun.

<!-- United States v. Wilson (No. 23-30777, 5th Cir. 2025-07-17, cluster 10636220, lead 11102807): born-draft frontier-stub lake record added under RULING P4-11 (tripwire-arc ingestion) — the post-Bruen point on the frisk/RS branch. Bold plain-text brief-mention (no wikilink, no case page this phase); CL opinion link only. DISTINCT from the 9th Cir. hash-match United States v. Luke Wilson (cluster 5296785, cited on Private and Foreign Searches) — plain text avoids the [[United States v. Wilson]] wikilink which resolves to that 9th Cir. page. LINT-17: no page-less wikilink. -->
...
| *[[Minnesota v. Dickerson]]*, 508 U.S. 366 (1993) | ***[[Plain View Doctrine#plain-feel-minnesota-v-dickerson\|Plain feel]].*** Contraband whose identity is immediately apparent by touch during a lawful weapons frisk may be seized; manipulating an object to identify it is not. | [[Plain View & Plain Feel]] | [opinion](https://www.courtlistener.com/opinion/112873/minnesota-v-dickerson/) |
...
- [*Minnesota v. Dickerson*, 508 U.S. 366 (1993)](https://www.courtlistener.com/opinion/112873/minnesota-v-dickerson/) (home: [[Plain View & Plain Feel]])
