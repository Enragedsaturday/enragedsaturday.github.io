...
**Apply it.**
1. **Confirm a valid *Terry* stop first.** No reasonable suspicion means no lawful detention and no power to demand identity. *[[Brown v. Texas|Brown v. Texas]]*.
...
4. **Keep it to a name.** *Hiibel* upholds a name-only command; it does not authorize compelling documents or answers to further questions.
...
- **Reading *Hiibel* to compel more than a name.** It upholds a name-only requirement and reserves whether a State may demand documents or an address.
