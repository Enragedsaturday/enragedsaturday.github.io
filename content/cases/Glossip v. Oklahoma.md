...
## Conclusion
Reversed and [[Reading and Citing Cases#on-remand|remanded]]. The prosecution's failure to correct Sneed's false testimony violated *Napue*, and because the Court had jurisdiction and the confession of error was amply supported, a new trial — not a remand for further evidentiary proceedings — was the appropriate remedy.
