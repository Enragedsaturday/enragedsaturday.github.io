...
**Status: Unverified — subsequent treatment not yet machine-verified.** This page was authored from a CourtListener-verified identity stub; its citator and progeny history have not completed the project's two-key verification, so it renders under the ⚪ banner until machine verification is complete. *Blue* is an exclusionary-rule anchor for the *scope of the remedy*: the sanction for an unconstitutional acquisition of evidence is suppression at trial, not dismissal of the indictment or a bar to prosecution. Teach it with the grand-jury and cost-benefit cases (*[[United States v. Calandra]]* and *[[Mapp v. Ohio]]*) as marking the outer boundary of what the exclusionary rule remedies.
