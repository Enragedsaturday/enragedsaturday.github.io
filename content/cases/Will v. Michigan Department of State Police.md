...
**Status: Unverified — subsequent treatment not yet machine-verified.** This page was authored from a CourtListener-verified identity stub; its citator and progeny history have not completed the project's two-key verification, so it renders under the ⚪ banner until machine verification is complete. *Will* anchors the "who is a defendant" question in § 1983 litigation: States and their officials in official capacity are not suable "persons" for damages. Teach it against its bookends: *[[Monell v. Department of Social Services]]* (municipalities *are* persons), *[[Hafer v. Melo]]* (state officials sued in their *individual* capacities *are* persons), and the *[[Common Legal Terms#ex-parte|Ex parte]] Young* injunctive-relief exception, as the map of which government defendants § 1983 reaches.
