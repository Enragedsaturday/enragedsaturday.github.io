...
## Issue
Whether the plain-view doctrine gave the officers probable cause to search Loines's vehicle without a warrant — in particular, whether the objects the detective claimed to see through the tinted window were actually in plain view and whether their incriminating character was "immediately apparent."
...
## Conclusion
**Reversed, conviction vacated, and remanded.** Judge Clay wrote for the panel (Cole, Clay, and Mathis, JJ.).
