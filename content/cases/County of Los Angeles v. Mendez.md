...
**Status: Unverified — subsequent treatment not yet machine-verified.** This page was authored from a CourtListener-verified identity stub; its citator and progeny history have not completed the project's two-key verification, so it renders under the ⚪ banner until machine verification is complete. *Mendez* keeps excessive-force analysis anchored to *[[Graham v. Connor|Graham]]*'s moment-of-force reasonableness and eliminates the provocation rule as a route to liability. It preserves, rather than forecloses, recovery for a distinct antecedent violation such as an unlawful entry — through a separate claim and ordinary proximate cause. Teach it as reinforcing that the "reasonableness" inquiry is not to be diluted by folding in earlier, independent Fourth Amendment wrongs.
