...
**Status: Unverified — subsequent treatment not yet machine-verified.** This page was authored from a CourtListener-verified identity stub; its citator and progeny history have not completed the project's two-key verification, so it renders under the ⚪ banner until machine verification is complete. *Imbler* is the foundational grant of **absolute prosecutorial immunity** for advocacy. The question it expressly reserved (whether investigative or administrative acts are also absolutely immune) was answered in *[[Buckley v. Fitzsimmons]]* (1993): only **qualified** immunity attaches to a prosecutor's investigative fabrication of evidence and press statements. Teach *Imbler* with *[[Buckley v. Fitzsimmons|Buckley]]* (the advocacy/investigation line) and *[[Briscoe v. LaHue]]* (witness immunity).
