...
**Status: Unverified — subsequent treatment not yet machine-verified.** This page was authored from a CourtListener-verified identity stub and renders under the ⚪ banner until machine verification is complete. *Brinkley* places the Fourth Circuit among the courts holding that *[[Payton v. New York|Payton]]*'s "reason to believe" means probable cause — deepening an acknowledged circuit split — and reinforces that when officers are uncertain whether their suspect is a resident or merely a guest, *[[Steagald v. United States|Steagald]]* demands a separate search warrant to protect the home's actual occupants.
