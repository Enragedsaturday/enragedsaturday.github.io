...
*[[City of Canton v. Harris|Canton]]* recognized a "narrow range" of single-incident liability where the need for training is so obvious and the violation so predictable that a pattern is unnecessary — but that exception is confined. "Failure to train prosecutors in their *Brady* obligations does not fall within the narrow range of *Canton's* hypothesized single-incident liability." — *Id.* at 64. ^pin-64
