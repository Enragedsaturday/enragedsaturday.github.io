...
**Overruled — the framework has twice been remade.** *Trupiano*'s "whenever reasonably practicable" warrant rule was rejected just two years later in *United States v. Rabinowitz*, 339 U.S. 56 (1950), which held that the test is whether a search incident to arrest is *reasonable*, not whether it was practicable to get a warrant. The Court then reversed course again in *[[Chimel v. California]]* (1969), overruling *Rabinowitz* and confining a search incident to arrest to the arrestee's person and the area within his immediate control — the rule that governs today.
...
## Appears on
- [[Search Incident to Arrest]] — *Historical / origin*
