...
**Status: Unverified — subsequent treatment not yet machine-verified.** This page was authored from a CourtListener-verified identity stub; its citator and progeny history have not completed the project's two-key verification, so it renders under the ⚪ banner until machine verification is complete. *Weatherford* anchors the rule that government intrusion into the attorney-client relationship violates the Sixth Amendment only on a showing of prejudice — communication of defense strategy, use of tainted evidence, or purposeful intrusion — not automatically. Teach it within the deliberate-elicitation line of *[[Massiah v. United States]]*, *[[United States v. Henry]]*, and *[[Kansas v. Ventris]]* as the case that declined a [[Common Legal Terms#per-se|per se]] remedy for informant presence at defense meetings.
