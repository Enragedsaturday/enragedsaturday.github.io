...
**Status: Unverified — subsequent treatment not yet machine-verified.** This page was authored from a CourtListener-verified identity stub; its citator and progeny history have not completed the two-key verification, so it renders under the ⚪ banner until machine verification is complete. *Bennis* remains the controlling answer to the recurring officer question whether a jointly owned or leased vehicle can be forfeited despite a co-owner's innocence: the Constitution supplies no innocent-owner defense (statutes may). Its holding subsumes the innocent-lessor language of the earlier *Calero-Toledo v. Pearson Yacht Leasing Co.* (1974), which anticipated this rule in the context of a leased vessel; *Bennis* states it as a general square holding.
