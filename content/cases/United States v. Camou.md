...
## Application
None of the three exceptions fit. The search was not incident to arrest, because the hour-and-twenty-minute gap and seven intervening acts made it not roughly contemporaneous with the arrest. It was not justified by exigency, because the agent never claimed the data was in danger of destruction, and it was not. And it could not rest on the vehicle exception, because a phone is not a container — treating it as one would let officers sift through all of a phone's data unbounded by the exigency or crime-relevance limits that cabin the other exceptions. The court also rejected the government's inevitable-discovery and good-faith arguments.

## Conclusion
**Reversed**: the warrantless search of Camou's cell phone violated the Fourth Amendment, and the images were not saved by inevitable discovery or good faith. Pregerson, J., wrote for the panel.
