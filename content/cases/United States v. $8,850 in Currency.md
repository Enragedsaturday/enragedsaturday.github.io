...
**Status: Unverified — subsequent treatment not yet machine-verified.** This page was authored from a CourtListener-verified identity stub; its citator and progeny history have not completed the project's two-key verification, so it renders under the ⚪ banner until machine verification is complete. *$8,850* is the timing anchor for civil forfeiture: the Government's delay in commencing a forfeiture action is tested under the *Barker v. Wingo* balancing factors rather than a rigid deadline, with the claimant's failure to demand a prompt hearing and the absence of prejudice weighing heavily. Teach it with *[[United States v. James Daniel Good Real Property]]* (1993), which governs the distinct question of *pre*-deprivation notice and hearing before the Government seizes real property.
