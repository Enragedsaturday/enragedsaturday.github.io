...
## Issue
Whether a subscriber has a Fourth Amendment reasonable expectation of privacy in the contents of emails held by a commercial ISP, such that the government must obtain a warrant before compelling the ISP to disclose them — and, if so, whether the exclusionary rule requires suppression.
...
## Conclusion
The court held the warrantless acquisition of Warshak's emails **violated the Fourth Amendment**, but declined to suppress the emails under the good-faith exception; the challenged convictions were **affirmed** on the email-privacy issue. Boggs, Circuit Judge, wrote for the court (McKeague, J., joined); Keith, J., concurred in the result.
