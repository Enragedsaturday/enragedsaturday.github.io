...
**Status: Unverified — subsequent treatment not yet machine-verified.** This page was authored from a CourtListener-verified identity stub; its citator and progeny history have not completed the project's two-key verification, so it renders under the ⚪ banner until machine verification is complete. *Giordano* supplies Title III's suppression test (evidence is suppressed for violating a statutory requirement only when that requirement "directly and substantially" implements Congress's intent to limit wiretapping) and holds the senior-approval requirement to be one of them. Teach it as the anchor of that test, paired with its companion *[[United States v. Donovan]]* (identification and inventory-notice violations, by contrast, do *not* require suppression) and *[[Scott v. United States]]* on minimization.
