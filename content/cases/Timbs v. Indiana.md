...
**Status: Unverified — subsequent treatment not yet machine-verified.** This page was authored from a CourtListener-verified identity stub; its citator and progeny history have not completed the project's two-key verification, so it renders under the ⚪ banner until machine verification is complete. *Timbs* completes the Excessive Fines line for state and local forfeitures: *[[Austin v. United States]]* (1993) held that punitive civil forfeitures are subject to the Clause, *[[United States v. Bajakajian]]* (1998) supplied the "grossly disproportional" excessiveness standard, and *Timbs* makes the Clause enforceable against the States. Teach it as the doctrine's reach: the guarantee that a state or municipal forfeiture, not just a federal one, can be challenged as an excessive fine.
