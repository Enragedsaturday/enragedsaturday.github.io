...
treatment:
  ...
  scope_note: "good_law is the headline validity (as of 2026-06-30); no confirmed downgrade in the current lake treatment field. The derivation carries proposed (un-adopted) negative/critical edges flagged audit_needed (\"R15 treatment audit required\"); none has been accepted. Maryland v. Shatzer later refines the Edwards line (a 14-day break in Miranda custody ends the Edwards bar) rather than overruling Roberson."
  point_overrides: []
courtlistener:
...
holding: "The Edwards bar is not offense-specific: after a suspect in custody invokes counsel, police may not initiate further custodial interrogation about any offense while counsel has not been made available, unless the suspect initiates further communication."
lake:
