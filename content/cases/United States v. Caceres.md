...
**Status: Unverified — subsequent treatment not yet machine-verified.** This page was authored from a CourtListener-verified identity stub; its citator and progeny history have not completed the project's two-key verification, so it renders under the ⚪ banner until machine verification is complete. *Caceres* anchors an outer limit of the exclusionary rule: suppression is a remedy for constitutional (and some statutory) violations, not for an agency's failure to follow its own internal procedures. It belongs with the deterrence-and-cost line (*[[Stone v. Powell]]*, *[[United States v. Calandra]]*, *[[United States v. Janis]]*, and *[[United States v. Leon]]*) that ties suppression to whether excluding evidence will meaningfully deter the violation of constitutional rights.
