...
## Rule
To invoke the hot-pursuit exception, officers must show (A) probable cause to search the home and (B) [[Exigent Circumstances and Hot Pursuit|exigent circumstances]] (the pursuit of a fleeing suspect) justifying the warrantless intrusion. The underlying principle, from *[[United States v. Santana]]*, 427 U.S. 38, 43 (1976) (quoted at slip op., at 8), is that "a suspect may not defeat an arrest which has been set in motion in a public place . . . by the expedient of escaping to a private place." The exception applies "only if the 'officers [were] in 'immediate' and 'continuous' pursuit of a suspect from the scene of the crime' at the moment they made entry." — *Newman v. Underhill*, 134 F.4th 1025 (9th Cir. 2025) (slip op., at 10). ^pin-op10
