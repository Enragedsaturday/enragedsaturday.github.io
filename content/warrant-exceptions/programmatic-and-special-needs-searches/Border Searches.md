...
- ***[[United States v. Kolsuz|Kolsuz]]* (4th Cir. 2018)** — *first post-Riley appellate holding.* After *Riley*, a forensic (off-site, weeks-long Cellebrite-type) device search at the border is non-routine and requires individualized suspicion. 890 F.3d 133. **Binding in-circuit — 4th Cir.**
