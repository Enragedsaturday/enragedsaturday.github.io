...
3. **Does another exception reach it?** Consent, a search incident to arrest, a standardized inventory, exigency, plain view, or the border can each independently authorize opening a container on their own terms.
...
3. **Otherwise, name your exception.** Consent, a search incident to arrest, a policy-driven inventory, exigency, plain view, or the border each has its own trigger and scope.
...
- **Reading *Chadwick* as dead.** It is limited only for containers in a car; a container searched on its own still starts from the warrant default (*[[California v. Acevedo|Acevedo]]*).
...
| *[[United States v. Place]]*, 462 U.S. 696 (1983) | ***Luggage detention.*** A dog sniff of luggage in public is not a search, but a 90-minute investigative seizure of the luggage exceeded *Terry* limits, the detention question distinct from opening the bag. | [[Reasonable Expectation of Privacy]] | [opinion](https://www.courtlistener.com/opinion/110979/united-states-v-place/) |
