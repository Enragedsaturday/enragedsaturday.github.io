...
The SCOTUS line (*Birchfield* / *McNeely* / *Mitchell*) governs; state courts continue to work out **implied-consent** mechanics — how far *Mitchell*'s unconscious-driver rule reaches, and whether statutory "consent" can substitute for a warrant after *Birchfield*. These turn on state statutes and are litigated state by state; no federal circuit rule displaces the SCOTUS framework.
