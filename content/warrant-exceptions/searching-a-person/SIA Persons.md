...
**Scope is the person and the place of arrest, never a separate general search.**
- The immediate-control limit is the modern successor to the founding-era rule that the search reaches **the person and the place of arrest**, not a "general exploratory search" of separate premises (*[[Agnello v. United States|Agnello]]*; *[[Go-Bart Importing Co. v. United States|Go-Bart]]*).
- The older, broader premises-search line (*[[Trupiano v. United States|Trupiano]]*, later rejected in *Rabinowitz*) was superseded by *[[Chimel v. California|Chimel]]*'s immediate-control limit; teach the scope through *[[Chimel v. California|Chimel]]*, not the dead pre-*[[Chimel v. California|Chimel]]* cases.

**The search must be roughly contemporaneous and confined to the arrest vicinity.**
- A search "remote in time or place from the arrest" cannot be justified as incident to it (*[[Preston v. United States|Preston]]*), and a house may not be searched as incident to an arrest made **outside** it, because a street arrest is not its own [[Exigent Circumstances and Hot Pursuit|exigency]] (*[[Shipley v. California|Shipley]]*; *[[Vale v. Louisiana|Vale]]*).
- Once effects are reduced to **exclusive police control** with no [[Exigent Circumstances and Hot Pursuit|exigency]], the search-incident theory is spent and a warrant is required (*[[United States v. Chadwick|Chadwick]]* — a seized footlocker).
