...
flowchart TD
  ...
  B --> D["Totality over TIME —<br/>events leading up count;<br/>no 'moment of threat' limit (Barnes)"]
  B --> E{"Deadly force?"}
  E -->|Yes| F["Garner: only on PC of significant<br/>threat of death / serious injury —<br/>and it's Graham applied,<br/>no on/off switch (Scott · Plumhoff)"]
  ...
  A3["Pretrial detainee"] --> H["14A objective reasonableness,<br/>no subjective intent (Kingsley)"]
  B --> I["Even if unreasonable →<br/>QUALIFIED IMMUNITY unless<br/>'clearly established' at HIGH specificity<br/>(Brosseau · Kisela · White · Rivas-Villegas · Sheehan)"]
```
